...
namespace RakHolidayHomes
{
    public class VPCRequest2
    {
        ...
        public VPCRequest2(IConfiguration config)
        {
            _config = config;
        ...
        public VPCRequest2(IWebHostEnvironment env)
        {
            _env = env;
        }
        ...
        public VPCRequest2()
        {
            ...
            _returnURL = _config["MySettings:vpc_ReturnURL2"];
